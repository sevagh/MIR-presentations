...
\begin{frame}
	...
	\begin{tikzpicture}[yscale=0.5,%
	    ...
	    \foreach \year/\desc [count=\y] in {%
	       ...
	       2012/Xiph gets Opus standardized in IETF in RFC 6716,%
	       2017/Opus updated in RFC 8251%
...
\begin{frame}
	...
	SILK codec implementation:\footfullcite{opuspapervoice}:
	\begin{itemize}
		\item
			Frequencies under 8kHz use SILK in Opus:
			\begin{quote}
			for speech, linear prediction techniques, such as Code-Excited Linear Prediction (CELP), code low frequencies more efficiently than transform (e.g., MDCT) domain techniques
			\end{quote}
		\item
...
\begin{frame}
	\frametitle{Cool extras}
	Auto-detection of speech and music -- tiny neural network wow
	Ambisonics, spatial features
\end{frame}
