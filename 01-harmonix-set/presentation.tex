...
\begin{frame}
	...
	\begin{enumerate}
		\item
			\textbf{M}usic \textbf{I}nformation \textbf{R}etrieval \textbf{E}valuation e\textbf{X}change: ``Audio Beat Tracking''\footcite{mirexabt}
		\item
			MIREX: ``Audio Downbeat Estimation''\footcite{mirexade}
		\item
			MIREX: ``Structural Segmentation''\footcite{mirexss}
	\end{enumerate}
\end{frame}
...
\begin{frame}
	...
	MIREX initial dataset included \textbf{The Beatles} and a subset of \textbf{RWC} (Real World Computing) \footcite{rwc}\\
	...
	\end{enumerate}
	Solutions: SALAMI\footcite{salami} (Structural Analysis of Large Amounts of Music Information), SPAM\footcite{spam} (Structural Poly Annotations of Music) include multiple annotations per track by different experts
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item
			Songs were annotated by trained professional musicians who regularly work in music production environments
		\item
			Mix of genres were chosen to be typical of ones used in the rhythm-action games, tendency to pop/electronic music for dancing
		\item
